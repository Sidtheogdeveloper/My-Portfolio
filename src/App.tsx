      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-16">
        ...
        <div className={`relative z-10 text-center max-w-5xl mx-auto px-6 transition-all duration-1000 ${
          ...
          <div className="mb-12 relative">
            <div className="w-52 h-52 mx-auto rounded-full bg-gradient-to-br from-blue-400 via-purple-500 to-cyan-400 p-1 shadow-2xl shadow-blue-500/20 hover:animate-profile-hover transition-all duration-300 cursor-pointer group">
            ...
            <div className="absolute -bottom-3 -right-3 w-16 h-16 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center animate-bounce shadow-lg shadow-green-500/30 group-hover:animate-pulse">
